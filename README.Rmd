...
This demo is run automatically by GitHub Actions, every day at midnight UTC, as well as whenever there is a change to `README.Rmd`.
...
I modified a bit at the start of the [Actions file](https://github.com/ijlyttle/projthis-demo/blob/master/.github/workflows/project-run.yaml) so that the build would be triggered by either:
